...
import net.meshmc.mesh.statics.*;
...
public class Statics implements IStatics {
    StaticMapColors mapColors = new StaticMapColors();
    @Override
    public IStaticMapColors getMapColor() {
        return mapColors;
    }

    StaticMaterials materials = new StaticMaterials();
    @Override
    public IStaticMaterials getMaterials() {
        return materials;
    }

    StaticPackets packets = new StaticPackets();
    @Override
    public IStaticPackets getPackets() {
        return packets;
    }
    ...
    @Override
    public Box createBox(double x1, double y1, double z1, double x2, double y2, double z2) {
        return (Box) new net.minecraft.util.math.Box(x1, y1, z1, x2, y2, z2);
    }

    @Override
    public Vec2f createVec2f(float x, float y) {
    ...
    @Override
    public Vec3f createVec3f(float x, float y, float z) {
    ...
    @Override
    public LocationIdentifier EntityAbstractClientPlayer_getSkinId(String playerName) {
